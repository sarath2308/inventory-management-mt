      ...
      <DataTable 
        ...
        renderActions={(row) => (
          <div className="flex gap-2">
            ...
            <button 
              onClick={() => { setSelectedCustomer(row); setIsConfirmOpen(true); }} 
      ...
      >
        <form className="space-y-5" onSubmit={handleSubmit}>
          <div className="space-y-4">
            <div>
              <label className="text-[10px] font-black text-zinc-500 uppercase tracking-widest mb-1.5 block">Full Name</label>
              <Input 
                name="name"
            ...
            <div>
              <label className="text-[10px] font-black text-zinc-500 uppercase tracking-widest mb-1.5 block">Mobile Number</label>
              <Input 
                name="mobile"
                type="tel" 
              ...
              {formData.mobile && !/^\d{10}$/.test(formData.mobile) && (
                <p className="text-[10px] text-red-500 mt-1 uppercase font-bold">Invalid mobile format</p>
              )}
            </div>

            <div>
              <label className="text-[10px] font-black text-zinc-500 uppercase tracking-widest mb-1.5 block">Full Address</label>
              <textarea 
                name="address"
          ...
          <button 
            type="submit"
            disabled={createCustomer.isPending || updateCustomer.isPending || !isFormValid}
          ...
          >
            {(createCustomer.isPending || updateCustomer.isPending) && <Loader2 className="animate-spin" size={18} />}
