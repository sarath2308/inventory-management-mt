    ...
    const columns: Column<ItemResponseType>[] = [
        ...
        },
        {
            ...
            cell: (row) => {
                if (row.quantity === 0) {
                    return (
                        <span className="px-2 py-0.5 rounded text-[10px] font-black uppercase border bg-gray-500/10 border-gray-500/50 text-gray-500">
                            Out of Stock
                        </span>
                    );
                }
                ...
                if (row.quantity < 5) {
                    return (
                        <span className="px-2 py-0.5 rounded text-[10px] font-black uppercase border bg-red-500/10 border-red-500/50 text-red-500">
                ...
                return (
                    <span className="px-2 py-0.5 rounded text-[10px] font-black uppercase border bg-emerald-500/10 border-emerald-500/50 text-emerald-500">
