      ...
      >
        ...
        <div className="flex items-center justify-between h-20 px-6">
          <div className="flex items-center gap-3">
            ...
            {isOpen && <span className="font-bold tracking-tight text-xl">StockFlow</span>}
          </div>
        </div>

        {/* Navigation Items */}
        <nav className="flex-1 px-3 space-y-2 mt-4">
          <SidebarItem to="/dashboard" icon={<LayoutDashboard size={22} />} label="Dashboard" isOpen={isOpen} />
          <SidebarItem to="/items" icon={<Package size={22} />} label="Items" isOpen={isOpen} />
          <SidebarItem to="/customers" icon={<Users size={22} />} label="Customers" isOpen={isOpen} />
          <SidebarItem to="/sales" icon={<BadgeDollarSign size={22} />} label="Sales" isOpen={isOpen} />
        </nav>
